...
img1 = cv2.imread('Resources/munch-chocolate.jpg')
img2 = cv2.imread('Resources/IMG_20210303_122309.jpg')

img1 = cv2.resize(img1,(0,0),fy=0.5,fx=0.5)
img2 = cv2.resize(img2,(0,0),fy=0.5,fx=0.5)
